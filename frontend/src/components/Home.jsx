...
function Home() {
  return (
    <>
        <div id="homeContainer" className='flex flex-col items-center justify-center max-w-[100%]'>
            ...
            <div id="copySectionWrapper" className='w-full pt-[120px] md:pt-[96px] xl:pt-[200px] bg-white'>
              <Copy />
            </div>
        </div>
    </>
